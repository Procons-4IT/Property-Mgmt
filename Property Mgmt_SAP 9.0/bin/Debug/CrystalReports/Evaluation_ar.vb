...
Public Class Evaluation_ar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Property_Mgmt.Evaluation_ar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEvaluation_ar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Evaluation_ar = New Evaluation_ar()
        rpt.Site = Me.Site
        Return rpt
    End Function
