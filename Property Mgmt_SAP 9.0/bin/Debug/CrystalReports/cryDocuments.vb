...
Public Class cryDocuments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Property_Mgmt.cryDocuments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryDocuments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryDocuments = New cryDocuments()
        rpt.Site = Me.Site
        Return rpt
    End Function
