...
Public Class Awqaf_Contract
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Property_Mgmt.Awqaf Contract.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAwqaf_Contract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Awqaf_Contract = New Awqaf_Contract()
        rpt.Site = Me.Site
        Return rpt
    End Function
