...
#Region "Methods"
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_PropertyData) = False Then
...
#Region "DataBind"
    Private Sub databind(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            oCombo = aForm.Items.Item("84").Specific
            Try
            ...
            End Try
            aForm.Items.Item("84").DisplayDesc = True
            aForm.Freeze(False)
        Catch ex As Exception
            oApplication.Utilities.Message(ex.Message, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            aForm.Freeze(False)
    ...
    Private Sub AddRow(ByVal aForm As SAPbouiCOM.Form)
        Select Case aForm.PaneLevel
            Case "1"
                ...
                oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP1")
            Case "4"
                oMatrix = aForm.Items.Item("108").Specific
                oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP2")
            Case "5"
                oMatrix = aForm.Items.Item("111").Specific
                oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP3")
        End Select
        Try
            aForm.Freeze(True)
            ' oMatrix = aForm.Items.Item("25").Specific
...
#Region "Delete Row"
    Private Sub RefereshDeleteRow(ByVal aForm As SAPbouiCOM.Form)
        ...
        End If
        oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP1")
        If aForm.PaneLevel = 4 Then
            oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP2")
            frmSourceMatrix = aForm.Items.Item("108").Specific
        ElseIf aForm.PaneLevel = 5 Then
            frmSourceMatrix = aForm.Items.Item("111").Specific
            oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP3")
        Else
            oDataSrc_Line = oForm.DataSources.DBDataSources.Item("@Z_PROP1")
            frmSourceMatrix = aForm.Items.Item("25").Specific
        End If
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CLICK
                                ...
                                oMatrix = oForm.Items.Item("25").Specific
                                If (pVal.ItemUID = "25" Or pVal.ItemUID = "108" Or pVal.ItemUID = "111") And pVal.Row > 0 Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                Select Case pVal.ItemUID
                                    ...
                                    Case "110"
                                        ...
                                        'End If
                                    Case "109"
                                        oMatrix = oForm.Items.Item("108").Specific
                                        AddRow(oForm)
                                        'If oMatrix.RowCount <= 0 Then
                                        '    oMatrix.AddRow()
                                        'End If
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        If pVal.ItemUID = "108" And pVal.ColUID = "V_0" Then
                                        ...
                                        If pVal.ItemUID = "111" And pVal.ColUID = "V_0" Then
