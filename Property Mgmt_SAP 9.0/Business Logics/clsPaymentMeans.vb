                ...
                Select Case pVal.BeforeAction
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                If pVal.ItemUID = "28" And (pVal.ColUID = "1" Or pVal.ColUID = "7") And pVal.CharPressed = 9 Then
                                    oMatrix = oForm.Items.Item(pVal.ItemUID).Specific
                                    Try
                                        oApplication.Utilities.SetMatrixValues(oMatrix, "U_Z_FROMDATE", pVal.Row, oApplication.Utilities.getMatrixValues(oMatrix, "1", pVal.Row))
                                        oMatrix.Columns.Item("7").Cells.Item(pVal.Row).Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                                    Catch ex As Exception
