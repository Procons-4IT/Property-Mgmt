Public Class clsTerminationApproval
    Inherits clsBase
    ...
    Public Sub LoadForm()
        Try
            oForm = oApplication.Utilities.LoadForm(xml_TermApproval, frm_TermApproval)
            oForm = oApplication.SBO_Application.Forms.ActiveForm()
            oForm.Freeze(True)
            oForm.PaneLevel = 1
            oForm.DataSources.DataTables.Add("dtDocumentList")
            oForm.DataSources.DataTables.Add("dtHistoryList")
            oApplication.Utilities.InitializationApproval(oForm, "TER")
            oApplication.Utilities.ApprovalSummary(oForm, "TER")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_TermApproval Then
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_MATRIX_LINK_PRESSED
                                If (pVal.ItemUID = "1" Or pVal.ItemUID = "19") And pVal.ColUID = "U_Z_CNTNO" Then
                                    ...
                                    For intRow As Integer = pVal.Row To pVal.Row
                                        If 1 = 1 Then
                                            ...
                                            strcode = oGrid.DataTable.GetValue("U_Z_CNTNO", intRow)
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("1").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("U_Z_DOCNO", pVal.Row)
                                    oApplication.Utilities.LoadHistory(oForm, "TER", strDocEntry)
                                ...
                                ElseIf pVal.ItemUID = "_1" Then
                                    ...
                                    If intRet = 1 Then
                                        oApplication.Utilities.addUpdateDocument(oForm, "TER")
                                    End If
                                End If
                                If pVal.ItemUID = "19" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("19").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("U_Z_DOCNO", pVal.Row)
                                    oApplication.Utilities.SummaryHistory(oForm, "TER", strDocEntry)
                                End If
