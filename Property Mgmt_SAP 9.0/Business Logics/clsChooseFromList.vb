...
#Region "Bind Data"
    ...
    Public Sub databound(ByVal objform As SAPbouiCOM.Form)
        Try
            ...
            If choice = "Bin" Then
                objform.Title = "Insurance Selection"
                If CFLChoice = "Insurance" Then
                    strSQL = "Select DocEntry,U_Z_PolicyNumber,U_Z_CompName,U_Z_TenCode,U_Z_UnitCode,U_Z_StartDate,U_Z_EndDate from [@Z_Insurance]  where U_Z_UnitCode='" & ItemCode & "' and ( isnull(U_Z_TenCode,'')='' or  U_Z_TenCode='" & Documentchoice & "') order by Docentry "
                    dtTemp.ExecuteQuery(strSQL)
                    objGrid.DataTable = dtTemp
                    objGrid.Columns.Item(0).TitleObject.Caption = "Document Number"
                    objGrid.Columns.Item(1).TitleObject.Caption = "Policy Number"
                    objGrid.Columns.Item(2).TitleObject.Caption = "Company Name"
                    objGrid.Columns.Item(3).TitleObject.Caption = "Tenent Code"
                    objGrid.Columns.Item(4).TitleObject.Caption = "Property Unit "
                    objGrid.Columns.Item(5).TitleObject.Caption = "Start Date"
                    objGrid.Columns.Item(6).TitleObject.Caption = "End Date"
                    objGrid.Columns.Item(1).Visible = True
                ElseIf CFLChoice = "ProUnit" Or CFLChoice = "Price" Then
                    Dim aform As SAPbouiCOM.Form
                    aform = GetForm(SourceFormUID)
                    If aform.TypeEx = frm_Reservation Then
                        If ItemCode = "" Then
                            strSQL = "Select U_Z_PropCode,U_Z_PropDesc,U_Z_ProItemCode,U_Z_Desc ,U_Z_OwnerCode,U_Z_Comm,U_Z_ExtProNo,U_Z_UsedFor1 from [@Z_PROPUNIT]  order by Docentry "
                        Else
                            strSQL = "Select U_Z_PropCode,U_Z_PropDesc,U_Z_ProItemCode,U_Z_Desc,U_Z_OwnerCode,U_Z_Comm,U_Z_ExtProNo,U_Z_UsedFor1 from [@Z_PROPUNIT]  where U_Z_PropCode='" & ItemCode & "' order by Docentry "
                        End If
                    Else
                        If ItemCode = "" Then
                            strSQL = "Select U_Z_PropCode,U_Z_PropDesc,U_Z_ProItemCode,U_Z_Desc ,U_Z_OwnerCode,U_Z_Comm,U_Z_ExtProNo,U_Z_UsedFor1 from [@Z_PROPUNIT]  where U_Z_UnitStatus<>'M' order by Docentry "
                        Else
                            strSQL = "Select U_Z_PropCode,U_Z_PropDesc,U_Z_ProItemCode,U_Z_Desc,U_Z_OwnerCode,U_Z_Comm,U_Z_ExtProNo,U_Z_UsedFor1 from [@Z_PROPUNIT]  where U_Z_PropCode='" & ItemCode & "' and U_Z_UnitStatus<>'M' order by Docentry "
                        End If
                    End If
                            ...
                            If CFLChoice <> "Cust" Then
                                If intRowId = 0 Then
                                    ...
                                    If CFLChoice = "ProUnit" Then
                                        ...
                                        strSelectedItem7 = Convert.ToString(oMatrix.DataTable.GetValue("U_Z_ExtProNo", intRowId))
                                ...
                                If choice = "Bin" Then
                                    If CFLChoice <> "Insurance" And CFLChoice <> "ProUnit" Then
                                        objSourcematrix = oForm.Items.Item(ItemUID).Specific
                                        'objSourcematrix.Columns.Item(sourceColumID).Editable = True
                                        objSourcematrix.Columns.Item(sourceColumID).Cells.Item(SourceLabel).Specific.value = strSelectedItem1
                                    ...
                                    ElseIf CFLChoice = "ProUnit" Then
                                        ...
                                        End Try
                                        Try
                                            oApplication.Utilities.setEdittextvalue(oForm, "edExtPro", strSelectedItem7)
                                        Catch ex As Exception
