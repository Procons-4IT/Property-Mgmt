Public Class clsLocation
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Location) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_Location, frm_Location)
...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("Select * from [@Z_OLOC] order by Code")
...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        agrid.Columns.Item(0).Visible = True
        agrid.Columns.Item(1).Visible = True
...
#Region "CommitTrans"
    Private Sub Committrans(ByVal strChoice As String)
        ...
        If strChoice = "Cancel" Then
            oTemprec.DoQuery("Update [@Z_OLOC] set NAME=CODE where Name Like '%D'")
        Else
          
            oTemprec.DoQuery("Delete from  [@Z_OLOC]  where NAME Like '%D'")
        End If
    ...
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If oGrid.DataTable.GetValue(0, intRow) <> "" Then
                ...
                oUserTable = oApplication.Company.UserTables.Item("Z_OLOC")
                If oGrid.DataTable.GetValue(0, intRow) = "" Then
                    ' strCode = oApplication.Utilities.getMaxCode("@Z_OLOC", "Code")
    ...
    Private Sub RemoveRow(ByVal intRow As Integer, ByVal agrid As SAPbouiCOM.Grid)
        ...
        For intRow = 0 To agrid.DataTable.Rows.Count - 1
            If agrid.Rows.IsSelected(intRow) Then
                ...
                otemprec.DoQuery("Select * from [@Z_PROP] where U_Z_LOCATION='" & strCode & "'")
                If otemprec.RecordCount > 0 Then
                    oApplication.Utilities.Message("Location already mapped to Property . You can not remove.", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Exit Sub
                End If

                oApplication.Utilities.ExecuteSQL(oTemp, "update [@Z_OLOC] set  NAME =NAME +'D'  where Code='" & strCode & "'")
        ...
        For intRow As Integer = 0 To aGrid.DataTable.Rows.Count - 1
            ...
            For intInnerLoop As Integer = intRow To aGrid.DataTable.Rows.Count - 1
                ...
                If strECode = strECode1 And intRow <> intInnerLoop Then
                    oApplication.Utilities.Message("Location Code already exists. Code no : " & strECode, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Location Then
