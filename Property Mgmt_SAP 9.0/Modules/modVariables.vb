Public Module modVariables
    ...
    Public Const xml_AppHisDetails As String = "frm_AppHisDetails.xml"
    Public Const frm_AppHisDetails As String = "frm_AppHisDetails"

    Public Const xml_TermTransaction As String = "frm_TermTransaction.xml"
    Public Const frm_TermTransaction As String = "frm_TermTransaction"
    Public Const mnu_TermTransaction As String = "Z_Menu_TerTrans"

    Public Const xml_ContractApproval As String = "frm_ContractApproval.xml"
    Public Const frm_ContractApproval As String = "frm_ContractApproval"
    Public Const mnu_ContractApproval As String = "Z_Menu_ConApp"

    Public Const xml_TermApproval As String = "frm_TermApproval.xml"
    Public Const frm_TermApproval As String = "frm_TermApproval"
    Public Const mnu_TermApproval As String = "Z_Menu_TerApp"

    Public Const xml_ApproveTemp As String = "frm_ApproveTemp.xml"
    Public Const frm_ApproveTemp As String = "frm_ApproveTemp"
    Public Const mnu_ApproveTemp As String = "Z_Menu_504"

    Public Const mnu_ProFac As String = "Z_Menu_403"
    Public Const xml_ProFac As String = "frm_ProFacMaster.xml"
    Public Const frm_ProFac As String = "frm_ProFac"

    Public Const mnu_ProUFac As String = "Z_Menu_503"
    Public Const xml_ProUFac As String = "frm_ProUFacMaster.xml"
    Public Const frm_ProUFac As String = "frm_ProUFac"
