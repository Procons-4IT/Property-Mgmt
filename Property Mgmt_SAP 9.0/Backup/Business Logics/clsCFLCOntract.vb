                            ...
                            If CFLChoice <> "Cust" Then
                                ...
                                If choice = "Contract" Then
                                    If CFLChoice = "Contract" Then
                                        ...
                                        objSourcematrix.Columns.Item(sourceColumID).Cells.Item(SourceLabel).Specific.value = strSelectedItem3
                                        objSourcematrix.Columns.Item("U_Z_CONTID").Cells.Item(SourceLabel).Specific.value = strSelectedItem2

                                        objSourcematrix.Columns.Item("U_Z_CNTNUMBER").Cells.Item(SourceLabel).Specific.value = strSelectedItem1
                                        objSourcematrix.Columns.Item("U_SEQ").Cells.Item(SourceLabel).Specific.value = strSelectedItem4
