    ...
    Private Sub Formatgrid(ByVal aForm As SAPbouiCOM.Form, ByVal aOption As String)
        ...
        Select Case aOption
            ...
            Case "Payroll"
                ...
                aGrid.Columns.Item("Rent").TitleObject.Caption = "Rent Increment Value"
