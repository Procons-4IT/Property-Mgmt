...
Public Class Private_Eng_office
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Property_Mgmt.Private Eng office.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrivate_Eng_office
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Private_Eng_office = New Private_Eng_office
        rpt.Site = Me.Site
        Return rpt
    End Function
