...
Public Class rent_general_format
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rent-general format.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Property_Mgmt.rent-general format.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrent_general_format
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rent_general_format = New rent_general_format
        rpt.Site = Me.Site
        Return rpt
    End Function
